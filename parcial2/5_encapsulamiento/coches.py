...
El-self-es-un-parámetro-es una-referencia-a•la instancia actual-de la-clase.y.
se-utiliza-para acceder-a-variables-que pertenecen-a•la-clase.
14
No es-necesario-que tenga-nombre-self, puedes 11amar lo•como quieras, •pero tiene-que ser-el priner parámetro-de cualquier función-de la clase. •Es• decir por• regla-se-utiliza-en-la-palabra-self-pero•puede-ser•llamado•con-otro-nombre•por•
...
class Coches:
    ...
    def __init__(self,color,marca,modelo,velocidad,caballaje,plazas):
        ...
        self.plazas=plazas
    #El encapsulamineto o visibilidad es importante que a traves de el es posible que python
    #sepa como va a utilizar y manipular los atributos y metodos de la clase
    #ATRIBUTO PUBLICO
    atributo_publico="Soy un atributo publico"
    #ATRIBUTO PRIVADO
    __atributo_privado="Soy un atributo privado"
    #Nota1 para utilizar un atributo privado es necesario usarlo dentro de un metodo publico
